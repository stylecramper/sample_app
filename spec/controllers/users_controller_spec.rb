...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        Factory(:user, :email => 'user@example.edu')
        Factory(:user, :email => 'amother@example.edu')
        Factory(:user, :email => 'another@example.edu')
        30.times do
  ...
  describe "GET 'show'" do
    ...
    it "should paginate microposts" do
      32.times { Factory(:micropost, :user => @user, :content => 'foo')}
      get :show, :id => @user
      response.should have_selector('div.pagination')
    end
  ...
  describe "PUT 'update" do
    ...
    describe "failure" do
      ...
      it "shouild have the right title" do
        put :update, :id => @user,  :user => @attr
        response.should have_selector('title', :content => 'Edit user')
      end
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => 'New Name', :email => 'foo@bar.com', :password => 'barfoo', :password_confirmation => 'barfoo'}
      end
